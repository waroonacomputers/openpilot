...
FEATURES = {
  "use_cluster_gears": [CAR.ELANTRA, CAR.KONA, CAR.SONATA_1, CAR.ELANTRA_GT_I30],     # Use Cluster for Gear Selection, rather than Transmission
...
DBC = {
  ...
  CAR.SONATA_1: dbc_dict('hyundai_kia_generic', None),
